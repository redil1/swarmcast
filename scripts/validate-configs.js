...
for (const check of [
  ...
  },
  {
    ...
    required: ["PEER_COUNT = 1000", "CELL_COUNT = 4", "CELL_MAX_PEERS = 300", "JOIN_BATCH_SIZE = 25", "TRACKER_CELL_LOAD_DOCKER_IMAGE", "reservePorts", "assignmentsByCell", "selectTrackerCell", "announceAndMeasure", "proveSignalingIsolation", "swarmcast_tracker_backpressure_drops_total", "swarmcast_tracker_cell_capacity_rejections_total", "RECOVERY_P95_BUDGET_MS", "closeCode=1012", "crossCellSignal=blocked", "tracker cell 1K WebSocket load OK"]
  },
  {
