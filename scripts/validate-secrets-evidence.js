...
const requiredSecretDefinitions = new Map([
  ...
  ["play-integrity-service-account", { purpose: "play integrity verdict decoding", injectedInto: ["auth"] }],
  ["attestation-challenge-secret", { purpose: "app attestation challenge signing", injectedInto: ["auth"] }],
