...
test("aggregatePeerStats computes offload and peer fractions", () => {
  ...
  assert.equal(stats.offloadRatio, 0.5);
...
test("recordPeerStats keeps cumulative counters, playback quality, and rolling window", () => {
  ...
  recordPeerStats(peer, { dl_p2p: 100, dl_edge: 0, ul: 25, stalls: 0, peer_timeouts: 2, hash_failures: 1, peer_disconnects: 0, startup_ms: 1200, buffer_ms: 45000 }, 0, 5000);
  recordPeerStats(peer, { dl_p2p: 0, dl_edge: 100, ul: 10, stalls: 1, peer_timeouts: 1, hash_failures: 0, peer_disconnects: 1, startup_ms: 800, buffer_ms: 20000 }, 6000, 5000);
